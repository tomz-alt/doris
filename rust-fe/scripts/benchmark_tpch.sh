...
# TPC-H Benchmark Runner (Pure Bash - ClickBench Style)
...
DATABASE="tpch_sf${SCALE}"
QUERIES_DIR="$(dirname "$0")/tpch/queries"
OUTPUT_JSON="tpch_results.json"
OUTPUT_HTML="tpch_results.html"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  --output-json FILE         Output JSON file (default: tpch_results.json)"
            echo "  --output-html FILE         Output HTML file (default: tpch_results.html)"
