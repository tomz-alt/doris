  ...
  pub fn const_value() -> BTreeMap<String, THdfsCompression> {
    BTreeMap::from([
      (
        "".to_owned(),
        {
          THdfsCompression::try_from(0).expect("expecting valid const value")
        },
      ),
      (
        "bzip2".to_owned(),
        {
          THdfsCompression::try_from(4).expect("expecting valid const value")
        },
      ),
      (
        "deflate".to_owned(),
        {
          THdfsCompression::try_from(1).expect("expecting valid const value")
        },
      ),
      (
        "gzip".to_owned(),
        {
          THdfsCompression::try_from(2).expect("expecting valid const value")
        },
      ),
      (
        "none".to_owned(),
      ...
      (
        "snappy".to_owned(),
        {
          THdfsCompression::try_from(5).expect("expecting valid const value")
        },
      ),
    ])
  }
